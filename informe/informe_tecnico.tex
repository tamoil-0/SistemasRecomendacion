...
\subsection{Despliegue web del prototipo}
...
\begin{table}[H]
\centering
\caption{Enlaces de despliegue y repositorio.}
\label{tab:despliegue}
\small
\begin{tabular}{p{3.7cm}p{8.7cm}}
\toprule
Recurso & Enlace \\ 
\midrule
Repositorio GitHub & \url{https://github.com/tamoil-0/SistemasRecomendacion.git} \\
Frontend publicado & \url{https://sistemas-recomendacion.vercel.app} \\
Backend publicado & \url{https://salud-preventiva-puno-api.onrender.com} \\
Documentacion API & \url{https://salud-preventiva-puno-api.onrender.com/docs} \\
\bottomrule
\end{tabular}
\end{table}

En Vercel se configuro el directorio \texttt{frontend/} como raiz del proyecto, usando Vite como framework de construccion. El frontend consume la API mediante la variable de entorno \texttt{VITE\_API\_URL}, apuntando al servicio publicado en Render. En Render se configuro el directorio \texttt{backend/} como raiz del servicio Docker, con variables de entorno para la conexion a PostgreSQL, clave secreta, tiempo de expiracion de token y origen permitido del frontend.

Tambien se realizo un ajuste de CORS para permitir el dominio del frontend publicado en Vercel. Con ello, las solicitudes de login, registro, recomendacion e historial pueden ejecutarse desde la aplicacion web desplegada. En el repositorio se excluyeron archivos que no deben subirse a GitHub, como entornos virtuales, \texttt{node\_modules/}, archivos \texttt{.env}, bases SQLite locales y builds generados. De esta manera, el repositorio conserva el codigo fuente necesario para reconstruir el sistema y evita incluir dependencias o secretos.
...
\begin{itemize}[leftmargin=*]
  ...
  \item El prototipo fue desplegado en la web mediante Vercel y Render, permitiendo validar el sistema desde enlaces publicos.
...
\begin{itemize}[leftmargin=*]
  ...
  \item Frontend desplegado: \href{https://sistemas-recomendacion.vercel.app}{sistemas-recomendacion.vercel.app}.
  \item Backend desplegado: \href{https://salud-preventiva-puno-api.onrender.com}{salud-preventiva-puno-api.onrender.com}.
  \item Documentacion interactiva de la API: \href{https://salud-preventiva-puno-api.onrender.com/docs}{salud-preventiva-puno-api.onrender.com/docs}.
